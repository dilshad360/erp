...
## Corpus Check
- 204 files · ~119,939 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1094 nodes · 1456 edges · 94 communities (76 shown, 18 thin omitted)
- Extraction: 100% EXTRACTED · 0% INFERRED · 0% AMBIGUOUS
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `b39237d1`
...
- [[_COMMUNITY_BUG-005 Remove Legacy Invite Employee Dashboard Page & Obsolete Invite Endpoints Post-Self-Signup Transition|[BUG-005]: Remove Legacy "Invite Employee" Dashboard Page & Obsolete Invite Endpoints Post-Self-Signup Transition]]
...
- [[_COMMUNITY_BUG-004 Mobile Viewport Bottom Scroll Clearance Obscured by BottomNav|BUG-004: Mobile Viewport Bottom Scroll Clearance Obscured by BottomNav]]
- [[_COMMUNITY_Stories Directory (`phasesstories`)|Stories Directory (`phases/stories/`)]]
- [[_COMMUNITY_route.ts|route.ts]]
- [[_COMMUNITY_PageHeader.tsx|PageHeader.tsx]]
- [[_COMMUNITY_graphify|graphify.md]]
- [[_COMMUNITY_graphify|graphify.md]]
- [[_COMMUNITY_Phase 3 — Attendance|Phase 3 — Attendance]]
- [[_COMMUNITY_page.tsx|page.tsx]]
...
- [[_COMMUNITY_GlobalPreloader.tsx|GlobalPreloader.tsx]]
- [[_COMMUNITY_ColorPicker.tsx|ColorPicker.tsx]]
- [[_COMMUNITY_ClientDetailClient.tsx|ClientDetailClient.tsx]]
- [[_COMMUNITY_ProjectDetailClient.tsx|ProjectDetailClient.tsx]]
- [[_COMMUNITY_route.ts|route.ts]]
- [[_COMMUNITY_page.tsx|page.tsx]]
...
4. `ERP SaaS — Master Task Tracker` - 15 edges
5. `TaskStatus` - 13 edges
6. `Design System — ERP SaaS` - 13 edges
7. `Frontend — Architecture, Pages & Components` - 13 edges
8. `LoadingButton()` - 11 edges
9. `Backend — Database, API & Supabase Configuration` - 11 edges
...
- `ClientsPage()` --calls--> `createClient()`  [EXTRACTED]
  app/(tenant)/[subdomain]/(app)/clients/page.tsx → lib/supabase/server.ts
...
Cohesion: 0.31
Nodes (8): AttendanceLog, AttendanceMonthCalendar(), AttendanceMonthCalendarProps, DayStatus, formatDuration(), formatTime(), getDayStatus(), STATUS_STYLES

### Community 1 - "EmployeeSettingsClient.tsx"
Cohesion: 0.20
Nodes (12): BottomNav(), primaryTabs, CompanyLogo(), CompanyLogoProps, shapeMap, sizeMap, MobileHeader(), navItems (+4 more)

### Community 2 - "TaskForm.tsx"
Cohesion: 0.07
Nodes (47): ClientListClient(), ClientListClientProps, generateMetadata(), ProjectTasksPage(), DateFilterKey, GlobalTask, GlobalTasksClient(), GlobalTasksClientProps (+39 more)
...
Cohesion: 0.09
Nodes (27): inter, metadata, viewport, AttendanceCheckInPanel(), AttendanceCheckInPanelProps, AttendanceLog, formatDuration(), formatDurationHMS() (+19 more)

### Community 5 - "dependencies"
Cohesion: 0.05
Nodes (41): dependencies, @base-ui/react, class-variance-authority, clsx, cn, date-fns, @dnd-kit/core, @dnd-kit/sortable (+33 more)
...
Cohesion: 0.11
Nodes (13): metadata, SettingsPage(), CompanyData, CompanySettingsClientProps, TabType, CompanySummaryData, EmployeeProfileData, EmployeeSettingsClientProps (+5 more)
...
Cohesion: 0.15
Nodes (15): DELETE(), GET(), PUT(), RouteProps, updateClientSchema, clientSchema, GET(), POST() (+7 more)
...
Cohesion: 0.18
Nodes (8): TenantPreloader(), TenantPreloaderProps, TenantContext, TenantContextValue, TenantProvider(), TenantProviderProps, useOptionalTenant(), applyBrandToDocument()

### Community 13 - "server.ts"
Cohesion: 0.11
Nodes (6): checkInSchema, POST(), checkOutSchema, POST(), metadata, NewProjectPage()

### Community 14 - "page.tsx"
Cohesion: 0.22
Nodes (4): 1. Description & Business Value, 2. Acceptance Criteria, 3. Implementation Subtasks, User Story — STORY-010: Tenant Company Branding Loaders & Granular Route/Table Skeletons
...
Cohesion: 0.25
Nodes (5): AppLayout(), AppLayoutProps, BeforeInstallPromptEvent, AppShell(), AppShellProps
...
Cohesion: 0.33
Nodes (5): Acceptance Criteria, Overview, STORY-008: Global Preloader & Navigation Progress Suite, Subtasks, User Story

### Community 28 - "route.ts"
Cohesion: 0.09
Nodes (21): 1. User Story Statement, 2. Business Value & Context, 3. Multi-Tenancy & Security Verification, 4. Technical Scope & Architecture, 5. Acceptance Criteria (Given-When-Then), 6. Edge Cases & Boundary Conditions, 7. Implementation Subtasks Breakdown, 8. Quality & Verification Gates (+13 more)
...
Cohesion: 0.25
Nodes (7): BUG-006: Workspace Brand Color Reset on Page Refresh & Universal Persistence, Changes Implemented, Defect Summary, Root Cause Analysis (RCA), Symptoms & User Experience Impact, Tenant Isolation & Multi-Tenancy Audit, Verification & Quality Gates

### Community 37 - "page.tsx"
Cohesion: 0.50
Nodes (3): generateMetadata(), SignupPage(), SignupPageProps
...
Cohesion: 0.14
Nodes (15): ClientSelect(), ClientSelectProps, DatePicker(), DatePickerProps, EmptyState(), EmptyStateProps, FormField(), FormFieldProps (+7 more)
...
### Community 53 - "cn"
Cohesion: 0.06
Nodes (4): AttendancePageSkeleton(), PageHeaderSkeletonProps, TablePageSkeletonProps, SkeletonTableProps
...
### Community 60 - "[BUG-005]: Remove Legacy "Invite Employee" Dashboard Page & Obsolete Invite Endpoints Post-Self-Signup Transition"
Cohesion: 0.22
Nodes (9): 1. Defect Description & Symptoms, 2. Environment & Context, 3. Steps to Reproduce, 4. Multi-Tenancy & Security Impact Assessment, 5. Root Cause Analysis (RCA), 6. Fix Implementation Plan, 7. Verification & Regression Checklist, 8. Post-Mortem & Preventative Action (+1 more)
...
Cohesion: 0.40
Nodes (4): AttendanceLog, AttendancePage(), AttendancePageProps, metadata
...
Cohesion: 0.12
Nodes (11): ClientFormData, clientFormSchema, ProjectDetailProps, NewProjectFormClientProps, ProjectFormData, projectFormSchema, ClientOption, LoadingButton() (+3 more)

### Community 68 - "route.ts"
Cohesion: 0.50
Nodes (3): createProjectSchema, GET(), POST()

### Community 69 - "EmployeeListClient.tsx"
Cohesion: 0.13
Nodes (13): EmployeeListClientProps, EmployeeProfile, ManagerOption, EmployeeProfilePage(), metadata, ProfileDetailClientProps, EmployeesPage(), metadata (+5 more)
...
### Community 72 - "BUG-004: Mobile Viewport Bottom Scroll Clearance Obscured by BottomNav"
Cohesion: 0.33
Nodes (5): 1. Description & Symptoms, 2. Root Cause Analysis (RCA), 3. Resolution, 4. Verification, BUG-004: Mobile Viewport Bottom Scroll Clearance Obscured by BottomNav
...
Cohesion: 0.21
Nodes (7): ForgotPasswordPage(), ForgotPasswordPageProps, generateMetadata(), SetPasswordPage(), LoginClientProps, TenantLoginBranding, createClient()

### Community 75 - "PageHeader.tsx"
Cohesion: 0.50
Nodes (3): createStatusSchema, GET(), POST()

### Community 79 - "Phase 3 — Attendance"
Cohesion: 0.50
Nodes (3): generateMetadata(), ProjectDetailPage(), ProjectDetailData

### Community 80 - "page.tsx"
Cohesion: 0.33
Nodes (8): generateMetadata(), SubdomainRootLayout(), TenantLayoutProps, BrandVariants, generateBrandCss(), getBrandColorVariants(), hexToRgb(), normalizeHex()
...
### Community 84 - "ColorPicker.tsx"
Cohesion: 0.40
Nodes (4): 1. Description & Business Value, 2. Acceptance Criteria, 3. Implementation Subtasks, User Story — STORY-011: Forgot Password & Self-Serve Account Recovery

### Community 85 - "ClientDetailClient.tsx"
Cohesion: 0.26
Nodes (7): ClientDetailProps, EditClientFormData, editClientSchema, ConfirmDialogProps, LoadingButtonProps, Button(), buttonVariants

### Community 86 - "ProjectDetailClient.tsx"
Cohesion: 0.25
Nodes (9): EditProjectFormData, editProjectSchema, ProjectTeamMember, TaskStatusCount, isHtmlContent(), isSafeUrl(), RichTextViewer(), RichTextViewerProps (+1 more)

### Community 87 - "route.ts"
Cohesion: 0.29
Nodes (6): 1. User Story, 2. Acceptance Criteria, 3. Implementation Details, 4. Verification & Quality Gates, Status, STORY-012: Rebrand Application to Octyvo & Scrub ERP/SaaS Terminology
...
Cohesion: 0.50
Nodes (3): ClientRecord, ClientsPage(), metadata

### Community 91 - "page.tsx"
Cohesion: 0.50
Nodes (3): generateMetadata(), LoginPage(), LoginPageProps

## Knowledge Gaps
- **594 isolated node(s):** `metadata`, `metadata`, `metadata`, `step1Schema`, `step2Schema` (+589 more)
...
- **Why does `createClient()` connect `createClient` to `TaskForm.tsx`, `EmployeeListClient.tsx`, `ProjectDetailClient.tsx`, `server.ts`, `route.ts`, `PageHeader.tsx`, `route.ts`, `route.ts`, `route.ts`, `page.tsx`, `[BUG-001]: Employee Users Exposed to Company-Level Workspace Settings and Missing Role-Specific Settings`, `page.tsx`, `TRACKER.md`, `route.ts`, `EmployeeListClient.tsx`, `page.tsx`, `route.ts`, `PageHeader.tsx`, `Phase 3 — Attendance`, `page.tsx`, `page.tsx`, `page.tsx`, `page.tsx`, `route.ts`?**
